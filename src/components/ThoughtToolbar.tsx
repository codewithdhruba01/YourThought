  ...
  return (
    <div className="flex flex-row items-center justify-between gap-4 mb-5 pb-3 border-b border-[#f3eee61a] font-sans text-[#f3eee675]">
      <div className="text-[0.9rem] font-medium tracking-[0.08em] uppercase whitespace-nowrap">
        <span className="text-[#f3eee6c7] font-variant-numeric tabular-nums">{count}</span> THOUGHTS
      </div>
      ...
      <div className="sm:hidden relative">
        ...
        >
          <option value="popular" className="bg-[#22211f] text-white">Popular</option>
          <option value="newest" className="bg-[#22211f] text-white">Newest</option>
          <option value="surprise" className="bg-[#22211f] text-white">Surprise me</option>
        </select>
      ...
      <div className="hidden sm:flex items-center justify-end gap-[0.3rem]">
        <span className="text-[0.9rem] tracking-[0.06em] uppercase mr-[0.35rem]">Show me:</span>
